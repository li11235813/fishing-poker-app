...
export default function App() {
  ...
  function handleSelectHand(card: Card) {
    if (!isMyTurn) return;
      ...
      <div className="shell">
        <aside className="panel">
          ...
          <div>
            ...
            {game?.status === 'finished' && (
              <p className="badge">
                {game.winnerId === 'draw' ? 'Draw' : game.winnerId === playerId ? 'Victory' : 'Defeat'}
              </p>
            )}
        ...
        <main className="board">
          ...
          <section className="panel">
            ...
            <div className="row">
              {me?.hand.map((card) => (
                <CardView key={card.id} card={card} selected={selectedHand === card.id} onClick={() => handleSelectHand(card)} />
              ))}
            </div>
